...
export const AuthLayout: React.FC<AuthLayoutProps> = ({
  ...
  return (
    <div className="relative min-h-[100dvh] overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-slate-950 flex flex-col sm:flex sm:items-center sm:justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 py-8 text-center text-[var(--color-surface)] sm:hidden min-h-[34vh] space-y-4">
        {showLogo && (
      ...
      <div className="relative z-10 w-full sm:max-w-2xl mt-auto sm:mt-0 px-0 sm:px-4 sm:py-8">
        <Card
