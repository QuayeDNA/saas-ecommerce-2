...
export const TutorialAutoTrigger: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="bg-[var(--color-surface)] rounded-xl shadow-lg border border-[var(--color-border)] p-4 text-[var(--color-text)]">
        <div className="flex items-start gap-3">
          <div className="shrink-0 w-9 h-9 rounded-full bg-[var(--color-primary-50)] text-[var(--color-primary-600)] flex items-center justify-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-2.5">
              <button
                onClick={accept}
                className="flex items-center gap-1 text-xs font-medium text-[var(--color-whatsapp-text)] bg-[var(--color-primary-600)] hover:bg-[var(--color-primary-700)] px-3 py-1.5 rounded-lg transition"
              >
              ...
              <button
                onClick={dismiss}
                className="text-xs text-[var(--color-muted-text)] hover:text-[var(--color-text)] px-2 py-1.5 transition"
              >
                Not now
              </button>
            </div>
          ...
          <button
            onClick={dismiss}
            className="shrink-0 text-[var(--color-gray-300)] hover:text-[var(--color-muted-text)] transition"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
